                ...
                <form onSubmit={cadastrarVeiculoMotorista}>
                    <Card.Body>
                            ...
                            <div className="row d-flex g-2 mt-2">
                                <div className="form-group col-sm-4">
                                    ...
                                    <input type="text" id='txt-placa-veiculo' maxLength={7} className='form-control' required={true} onChange={(e) => setPlaca(e.target.value)} />
                                </div>
                                <div className="form-group col-sm-4">
                                ...
                                <div className="form-group col-sm-4">
                                    ...
                                    <input type="number" id='txt-lugares-veiculo' min={0} max={20} maxLength={3} className='form-control' required={true} onChange={(e) => setLugares(e.target.value)} />
                                </div>
                            </div>
                    ...
                    <Card.Footer className='fix-card-footer-border-radius'>
                        <div className="row d-flex g-2">
                            ...
                            <div className="form-group col-sm-3">
                                <button type='button' className='btn btn-secondary w-100'><i class="fa fa-trash" aria-hidden="true"></i> Limpar Campos</button>
                            </div>
                            <div className="form-group col-sm-6">
